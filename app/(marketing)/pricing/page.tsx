...
const Features = (props: Props) => {
  return (
    <>
      <div className="relative z-[-1] md:py-[3rem] lg:py-[6rem] w-[100%]">
      ...
      <div className="w-[90%] py-[5rem] grid grid-cols-1 md:grid-cols-2 items-center gap-4">
        <div>
          <div className="relative z-[-1] w-full  max-w-[80rem] mx-auto">
            <Image
              src={Atm}
              alt="AtmImage"
              className="w-full  z-[-1]  h-[100%] rounded-none lg:max-w-[480px]"
            />
            <Image
              src={PriceSettlement}
              alt="PriceSettlementImage"
              className="absolute w-[37%] z-[2]  md:top-[-3.5rem] md:right-5"
            />
            <Image
              src={PayPoint}
              alt="PayPointImage"
              className="absolute z-[2]  w-[37%] top-[-2rem] right-0 md:left-0 md:top-[75%]"
            />
          </div>
        </div>
        <div className="pt-5 flex items-center">
          <div className="pt-3 md:pt-0">
            ...
            <p className="mt-3 mb-5 tracking-wide max-w-[50rem] md:mt-6 mx-auto md:text-lg text-start">
              We charge 2% transaction fee or N2500 Cap for transactions
              N100,000 and above.
            </p>
            <button className="text-white capitalize bg-[#091F8E] py-1 px-3 md:py-2 md:px-4 text-[12px] md:text-base xl:text-xl">
              try paystride for free
