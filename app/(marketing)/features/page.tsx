...
import Settle from "@/app/(marketing)/assets/Laptop1.svg";
import Dash from "@/app/(marketing)/assets/Laptop2.svg";
  ...
  return (
    <>
      <div className="relative md:py-[3rem] lg:py-[6rem] w-[100%]">
        <div className="bg-[#d0d0df] pt-9 pb-5 z-[-1] lg:pb-11 relative w-[100%] md:w-[90%] mx-auto grid grid-cols-1 md:grid-cols-5 md:rounded-2xl">
          ...
          <div className="mx-auto py-5 top-[4.7%] xl:top-[2%] col-span-2 w-[90%] md:w-auto right-[7%] xl:right-[10%] lg:absolute ">
            <Image
              ...
              src={Basket}
              priority
              className="relative bottom-24 rounded-2xl max-h-[300px] md:max-h-[400px] w-full lg:w-[340px] lg:max-h-[450px] xl:w-[380px] xl:max-h-[480px]"
            />
          </div>
        </div>
      </div>
