                        ...
                        <div className="w-[90%] md:w-[80%] lg:w-[75%] relative">
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <p className="text-[19px] hidden md:flex items-center">
                                    <span className="bg-[#32a7e21a] w-16 h-16 mr-[6px] flex items-center justify-center rounded-3xl">
                                ...
                                <div className="block md:hidden">
                                    <div className="flex items-center">
                                        <span className="bg-[#32a7e21a] w-12 h-12 sm:w-16 sm:h-16 mr-[6px] flex items-center justify-center rounded-2xl sm:rounded-3xl">
                                            <Image
                                                src={Cart}
                                                alt="Cart"
                                                className="w-7 sm:w-auto"
                                            />
                                        </span>
                                        <div>
