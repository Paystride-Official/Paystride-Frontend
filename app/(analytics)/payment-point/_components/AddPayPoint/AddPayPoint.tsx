    ...
    <div>
      ...
      >
        ...
        <div className=" flex gap-4">
          <div>
            <p className="text-[10px] text-[#B9B9B9]">First Name</p>
            <input
              type="text"
              placeholder="chidi"
          ...
          <div>
            <p className="text-[10px] text-[#B9B9B9]">Last Name</p>
            <input
              type="text"
              placeholder="chidi"
              className=" block border-[0.889px] border-solid border-[#D9D9D9] px-2 py-2 outline-none  rounded-md"
        ...
        <div className="w-full  px-3.5">
          <p className="text-[10px] text-[#B9B9B9]">NO of payment point</p>
          <input
            type="text"
            placeholder="2"
            {...register("amount")}
            className=" py-2 px-2 w-full outline-none border-[0.889px] border-solid border-[#D9D9D9] rounded-md"
          />
        </div>
