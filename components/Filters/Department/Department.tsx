...
const Department = ({ filters, setFilters }: Props) => {
    ...
    useEffect(() => {
        const updatedFilters = { ...filters, department: selectedOption };
        setFilters(updatedFilters); // Update parent filter object
    }, [selectedOption]);

    const options = [
        { value: "sales", option: "Sales" },
        { value: "procurement", option: "Procurement" },
    ];
    ...
    return (
        <div>
            <div className="capitalize">
                ...
                <p className="text-[#333333B2] mb-1">department</p>
            </div>
